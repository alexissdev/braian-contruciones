...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 bg-blue-50 text-center overflow-hidden">
        ...
        >
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition rounded-xl flex flex-col justify-center items-center text-white p-4">
      ...
      <AnimatePresence>
        {active && (
          ...
          >
            <motion.div
              className="bg-white rounded-xl p-6 max-w-lg w-full text-left"
            ...
            >
              ...
              <p className="mb-6 text-gray-700">{active.desc}</p>
